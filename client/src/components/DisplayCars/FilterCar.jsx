...
const FilterCar = () => {
  ...
  return (
    <div className="fixed top-0 left-0  p-6 w-56 h-full shadow-2xl rounded-lg ">
      <h3 className="text-xl font-semibold text-gray-950 mb-4">Filter Cars</h3>

      {/* Filter by Brand */}
      <div className="filter-section mb-4">
        <h4 className="text-lg font-medium text-gray mb-2">Brand</h4>
      ...
      {/* Filter by Model */}
      <div className="filter-section mb-4">
        <h4 className="text-lg font-medium text-gray mb-2">Segment</h4>
        <label className="block text-gray-700 mb-2">
          <input
            type="checkbox"
            value="sedan"
      ...
      <div className="filter-section mb-4">
        <h4 className="text-lg font-medium text-gray mb-2">Transmission</h4>
        <label className="block text-gray-700 mb-2">
          <input
            type="checkbox"
            value="manual"
      ...
      {/* Filter by Fuel */}
      <div className="filter-section mb-4">
        <h4 className="text-lg font-medium text-gray mb-2">Fuel</h4>
        <label className="block text-gray-700 mb-2">
          <input
            type="checkbox"
            value="petrol"
      ...
      {/* Filter by Price */}
      {/* <div className="filter-section mb-4">
        <h4 className="text-lg font-medium text-gray mb-2">Price</h4>
        <input
          type="range"
          min="0"
          ...
          className="w-full"
        />
        <div className="text-gray-700">{`Max Price: ₹${filters.price}`}</div>
      </div> */}

      {/* Filter by Mileage */}
      {/* <div className="filter-section mb-6">
        <h4 className="text-lg font-medium text-gray mb-2">Mileage</h4>
        <input
          type="number"
          placeholder="Max Mileage (km/l)"
          value={filters.mileage}
          onChange={(e) => handleInputChange('mileage', e.target.value)}
          className="w-full p-2 border border-gray-300 rounded-md text-gray focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div> */}

      {/* Apply Filter Button */}
      {/* <button className="w-full py-2 bg-blue-500 text-white rounded-md font-semibold text-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
        Apply Filters
      </button> */}
    </div>
  );
